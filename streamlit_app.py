...
# Catálogo COMPLETO de todos os códigos CNJ por área do Direito
# Inclui todas as classes processuais mapeadas no DataJud/TPU para cada ramo jurídico
LEGAL_AREAS_ALL_CODES: dict[str, list[tuple[int, str]]] = {
    "consumidor": [
        (436, "Procedimento do Juizado Especial Cível"),
        (7, "Procedimento Comum Cível"),
        (11984, "Indenização por Dano Moral / Material"),
        ...
        (159, "Execução de Título Extrajudicial"),
        (156, "Cumprimento de Sentença"),
        (27, "Ação Declaratória"),
        (26, "Ação Cominatória"),
        (12085, "Revisão de Contrato"),
        (12088, "Rescisão / Resolução de Contrato"),
        (12089, "Devolução de Quantia Paga"),
        (12090, "Repetição de Indébito"),
        (12097, "Substituição do Produto"),
        (12098, "Vício do Produto"),
        (12099, "Vício do Serviço"),
        (14741, "Negativação Indevida / Inclusão em Cadastro"),
        (12187, "Cancelamento de Voo / Transporte Aéreo"),
        (12186, "Extravio de Bagagem"),
        (12154, "Despejo por Falta de Pagamento"),
        (12103, "Cobrança de Valores Indevidos"),
        (12091, "Plano de Saúde / Seguro Saúde"),
        (12092, "Fornecimento de Medicamentos"),
        (12105, "Telefonia / Telecomunicações"),
        (12106, "Energia Elétrica / Gás"),
        (12107, "Água e Esgoto"),
        (12108, "Cartão de Crédito"),
        (12109, "Empréstimo Consignado"),
        (12110, "Financiamento de Veículo"),
        (12111, "Seguro (Geral)"),
        (12112, "Transporte de Mercadoria"),
        (12100, "Propaganda Enganosa"),
        (12101, "Produto Impróprio para Consumo"),
        (12113, "Bancário / Instituição Financeira"),
        (12114, "Consórcio"),
        (12115, "Incorporação Imobiliária (Consumidor)"),
        (12116, "Compra e Venda - Imóvel na Planta"),
        (1107, "Busca e Apreensão em Alienação Fiduciária"),
        (63, "Ação Civil Pública (Consumidor)"),
    ],
    "penal": [
        (283, "Ação Penal - Procedimento Ordinário"),
        (386, "Execução da Pena"),
        ...
        (280, "Termo Circunstanciado (JECRIM)"),
        (12729, "Acordo de Não Persecução Penal (ANPP)"),
        (281, "Ação Penal - Procedimento Sumaríssimo"),
        (284, "Ação Penal - Procedimento Especial"),
        (287, "Medidas Cautelares Criminais"),
        (288, "Busca e Apreensão Criminal"),
        (299, "Queixa-Crime"),
        (305, "Revisão Criminal"),
        (385, "Execução Provisória"),
        (1721, "Liberdade Provisória"),
        (309, "Mandado de Segurança Criminal"),
        (393, "Medida de Segurança"),
        (290, "Pedido de Prisão Preventiva"),
        (291, "Pedido de Prisão Temporária"),
        (292, "Relaxamento de Prisão"),
        (293, "Restituição de Coisas Apreendidas"),
        (294, "Sequestro de Bens (Criminal)"),
        (300, "Exceção de Suspeição Criminal"),
        (301, "Exceção de Incompetência Criminal"),
        (302, "Carta Precatória Criminal"),
        (303, "Carta Rogatória Criminal"),
        (306, "Recurso em Sentido Estrito"),
        (308, "Recurso de Apelação Criminal"),
        (304, "Embargos de Declaração Criminal"),
        (387, "Livramento Condicional"),
        (388, "Indulto / Comutação de Pena"),
        (389, "Progressão de Regime"),
        (390, "Remição de Pena"),
        (391, "Unificação de Penas"),
        (392, "Detração de Pena"),
        (394, "Sursis (Suspensão Condicional da Pena)"),
        (395, "Transferência de Preso"),
        (12730, "Audiência de Custódia"),
        (14985, "Monitoramento Eletrônico"),
        (285, "Crimes Contra a Vida (Tribunal do Júri)"),
        (286, "Crimes de Responsabilidade"),
        (296, "Incidente de Insanidade Mental"),
    ],
    "civel": [
        (7, "Procedimento Comum Cível"),
        (159, "Execução de Título Extrajudicial"),
        ...
        (12085, "Revisão de Contrato"),
        (12088, "Rescisão / Resolução de Contrato"),
        (12155, "Despejo por Denúncia Vazia"),
        (12156, "Renovatória de Locação"),
        (12157, "Revisional de Aluguel"),
        (12158, "Consignação de Aluguel"),
        (12159, "Despejo por Infração Contratual"),
        (12160, "Despejo para Uso Próprio"),
        (161, "Ação de Cobrança"),
        (162, "Ação de Reintegração de Posse"),
        (163, "Ação de Manutenção de Posse"),
        (164, "Interdito Proibitório"),
        (165, "Embargos de Terceiro"),
        (166, "Embargos à Execução"),
        (167, "Impugnação ao Cumprimento de Sentença"),
        (168, "Ação Reivindicatória"),
        (169, "Usucapião"),
        (170, "Ação de Divisão e Demarcação"),
        (171, "Nunciação de Obra Nova"),
        (172, "Ação de Dano Infecto"),
        (23, "Ação de Consignação em Pagamento"),
        (24, "Ação de Depósito"),
        (25, "Ação de Prestação de Contas"),
        (28, "Ação Constitutiva"),
        (29, "Cautelar Inominada"),
        (30, "Arresto / Sequestro"),
        (31, "Produção Antecipada de Provas"),
        (32, "Notificação / Interpelação Judicial"),
        (33, "Protesto Judicial"),
        (34, "Exibição de Documento"),
        (35, "Justificação"),
        (36, "Homologação de Transação Extrajudicial"),
        (37, "Tutela Antecipada Antecedente"),
        (38, "Tutela Cautelar Antecedente"),
        (120, "Mandado de Segurança Cível"),
        (160, "Execução contra a Fazenda Pública"),
        (157, "Cumprimento Provisório de Sentença"),
        (158, "Execução de Título Judicial"),
        (12117, "Retificação de Registro Civil"),
        (12118, "Interdição / Curatela"),
        (12119, "Alvará Judicial"),
        (12120, "Habilitação de Casamento"),
    ],
    "trabalhista": [
        (1125, "Ação Trabalhista - Rito Ordinário"),
        (1126, "Ação Trabalhista - Rito Sumaríssimo"),
        ...
        (1009, "Consignação em Pagamento Trabalhista"),
        (1127, "Ação Trabalhista - Rito Sumário"),
        (1103, "Execução Provisória Trabalhista"),
        (1104, "Execução de Contribuição Previdenciária Trabalhista"),
        (1105, "Execução de Custas e Emolumentos"),
        (1106, "Execução de Título Extrajudicial Trabalhista"),
        (1107, "Ação de Cumprimento de Sentença Normativa"),
        (1108, "Mandado de Segurança Trabalhista"),
        (1109, "Habeas Corpus Trabalhista"),
        (1110, "Correição Parcial Trabalhista"),
        (1111, "Dissídio Coletivo de Greve"),
        (1112, "Dissídio Coletivo de Natureza Econômica"),
        (1113, "Dissídio Coletivo de Natureza Jurídica"),
        (1114, "Dissídio Coletivo Revisional"),
        (1115, "Inquérito Judicial para Apuração de Falta Grave"),
        (1117, "Recurso Ordinário Trabalhista"),
        (1118, "Recurso de Revista Trabalhista"),
        (1119, "Agravo de Instrumento Trabalhista"),
        (1120, "Agravo de Petição Trabalhista"),
        (1121, "Embargos de Declaração Trabalhistas"),
        (1122, "Embargos à Execução Trabalhista"),
        (1123, "Exceção de Pré-Executividade Trabalhista"),
        (1124, "Homologação de Acordo Extrajudicial Trabalhista"),
        (1128, "Ação Civil Pública Trabalhista"),
        (1129, "Tutela Cautelar/Antecipada Trabalhista"),
        (1130, "Reclamação Correicional Trabalhista"),
        (14050, "Incidente de Desconsideração da Personalidade Jurídica (Trab.)"),
        (14051, "Pedido de Demissão em Massa"),
    ],
    "tributario": [
        (1116, "Execução Fiscal"),
        (120, "Mandado de Segurança Cível/Tributário"),
        ...
        (159, "Execução de Título Extrajudicial Tributário"),
        (40, "Ação Monitória Tributária"),
        (27, "Ação Declaratória de Inexistência de Débito"),
        (156, "Cumprimento de Sentença (Tributário)"),
        (166, "Embargos à Execução Fiscal"),
        (167, "Impugnação ao Cumprimento de Sentença (Tributário)"),
        (165, "Embargos de Terceiro (Execução Fiscal)"),
        (12090, "Repetição de Indébito Tributário"),
        (12085, "Ação de Compensação Tributária"),
        (63, "Ação Civil Pública (Tributário)"),
        (160, "Execução contra a Fazenda Pública"),
        (12121, "ICMS / ISS / IPTU / IPVA"),
        (12122, "IR / IRPJ / CSLL / PIS / COFINS"),
        (12123, "Contribuição Previdenciária sobre Receita Bruta"),
        (12124, "Contribuições Sociais (FGTS/INSS)"),
        (12125, "Taxa de Fiscalização"),
        (12126, "Multa Administrativa Fiscal"),
        (12127, "ITCD / ITBI / Imposto de Transmissão"),
        (12128, "Simples Nacional / MEI"),
        (29, "Cautelar Fiscal"),
        (30, "Arresto / Sequestro / Indisponibilidade de Bens"),
    ],
    "familia": [
        (98, "Divórcio Litigioso"),
        (97, "Divórcio Consensual"),
        ...
        (131, "Regulamentação de Visitas / Guarda"),
        (12015, "Execução de Alimentos"),
        (99, "Separação Judicial"),
        (100, "Separação Consensual"),
        (101, "Reconhecimento / Dissolução de União Estável"),
        (102, "Investigação de Paternidade"),
        (103, "Negatória de Paternidade"),
        (104, "Oferta de Alimentos"),
        (105, "Revisional de Alimentos"),
        (106, "Exoneração de Alimentos"),
        (107, "Alteração de Guarda"),
        (108, "Busca e Apreensão de Menor"),
        (109, "Alvará Judicial (Família)"),
        (110, "Interdição / Curatela"),
        (111, "Tutela e Curatela"),
        (112, "Suprimento de Capacidade/Consentimento"),
        (113, "Retificação de Registro Civil"),
        (114, "Alteração de Nome / Prenome"),
        (115, "Conversão de União Estável em Casamento"),
        (48, "Adoção"),
        (12129, "Alienação Parental"),
        (12130, "Reconhecimento de Multiparentalidade"),
        (12131, "Guarda Compartilhada"),
        (12132, "Partilha de Bens (Família)"),
        (12133, "Alimentos Gravídicos"),
        (12134, "Arrolamento (Sucessão)"),
        (12135, "Sobrepartilha"),
        (12136, "Testamento / Codicilo"),
        (12137, "Habilitação de Casamento"),
        (12138, "Alimentos Avoengos"),
    ],
    "previdenciario": [
        (7, "Procedimento Comum Cível (Previdenciário)"),
        (436, "Juizado Especial Cível/Federal (Previdenciário)"),
        (11984, "Concessão de Aposentadoria / Auxílio"),
        (156, "Cumprimento de Sentença contra o INSS"),
        (12139, "Aposentadoria por Idade"),
        (12140, "Aposentadoria por Tempo de Contribuição"),
        (12141, "Aposentadoria por Invalidez"),
        (12142, "Aposentadoria Especial"),
        (12143, "Aposentadoria Rural"),
        (12144, "Auxílio-Doença / Incapacidade Temporária"),
        (12145, "Auxílio-Acidente"),
        (12146, "Auxílio-Reclusão"),
        (12147, "Salário-Maternidade"),
        (12148, "Pensão por Morte"),
        (12149, "BPC / LOAS - Benefício Assistencial"),
        (12150, "Revisão de Benefício Previdenciário"),
        (12151, "Restabelecimento de Benefício"),
        (12152, "Desaposentação / Reaposentação"),
        (12153, "Averbação de Tempo de Serviço/Contribuição"),
        (120, "Mandado de Segurança contra o INSS"),
        (159, "Execução contra Autarquia Previdenciária"),
        (160, "Execução contra a Fazenda Pública (INSS)"),
        (40, "Ação Monitória Previdenciária"),
        (12161, "Conversão de Tempo Especial em Comum"),
        (12162, "Complementação de Aposentadoria"),
        (12163, "Reajuste de Benefício"),
    ],
    "constitucional": [
        (120, "Mandado de Segurança Cível"),
        (65, "Ação Civil Pública"),
        ...
        (12028, "Habeas Data"),
        (307, "Habeas Corpus"),
        (121, "Mandado de Segurança Coletivo"),
        (122, "Mandado de Injunção"),
        (63, "Ação Direta de Inconstitucionalidade (ADI)"),
        (67, "Ação Declaratória de Constitucionalidade (ADC)"),
        (68, "ADPF - Arguição de Descumprimento de Preceito Fundamental"),
        (69, "Intervenção Federal / Estadual"),
        (70, "Reclamação Constitucional"),
        (71, "Conflito de Competência"),
        (12164, "Ação Direta de Inconstitucionalidade por Omissão (ADO)"),
        (12165, "Suspensão de Segurança"),
        (12166, "Suspensão de Liminar/Tutela"),
        (12167, "Pedido de Suspensão de Eficácia de Decisão"),
        (12168, "Representação de Inconstitucionalidade (Estadual)"),
    ],
    "empresarial": [
        (129, "Recuperação Judicial"),
        (108, "Falência de Empresários e Sociedades"),
        (7, "Dissolução Parcial de Sociedade"),
        (159, "Execução de Título Empresarial"),
        (130, "Recuperação Extrajudicial"),
        (131, "Autofalência"),
        (132, "Habilitação de Crédito na Falência"),
        (133, "Impugnação de Crédito"),
        (134, "Pedido de Restituição"),
        (135, "Ação Revocatória Falimentar"),
        (12169, "Dissolução Total de Sociedade"),
        (12170, "Exclusão de Sócio"),
        (12171, "Apuração de Haveres"),
        (12172, "Conflito Societário"),
        (12173, "Propriedade Industrial / Marcas e Patentes"),
        (12174, "Concorrência Desleal"),
        (12175, "Franquia Empresarial"),
        (12176, "Contrato de Distribuição/Representação Comercial"),
        (12177, "Títulos de Crédito (Nota Promissória, Duplicata, Cheque)"),
        (40, "Ação Monitória de Título de Crédito"),
        (27, "Ação Declaratória (Empresarial)"),
        (14052, "Incidente de Desconsideração da Personalidade Jurídica"),
    ],
    "administrativo": [
        (64, "Ação Civil de Improbidade Administrativa"),
        (65, "Ação Civil Pública Administrativa"),
        (91, "Desapropriação"),
        (7, "Procedimento Comum Cível (Servidor/Contrato)"),
        (120, "Mandado de Segurança"),
        (12178, "Concurso Público / Nomeação"),
        (12179, "Servidor Público - Reajuste de Vencimentos"),
        (12180, "Servidor Público - Progressão / Promoção"),
        (12181, "Servidor Público - Processo Administrativo Disciplinar"),
        (12182, "Licitação e Contrato Administrativo"),
        (12183, "Tombamento / Proteção do Patrimônio"),
        (12184, "Responsabilidade Civil do Estado"),
        (12185, "Ato Administrativo - Anulação"),
        (66, "Ação Popular (Administrativo)"),
        (160, "Execução contra a Fazenda Pública"),
        (156, "Cumprimento de Sentença contra a Fazenda Pública"),
        (27, "Ação Declaratória (Administrativo)"),
        (11984, "Indenização por Dano Moral/Material (Estado)"),
        (12188, "Poder de Polícia / Multa Administrativa"),
        (12189, "Registro de Preços / Pregão Eletrônico"),
    ],
    "ambiental": [
        (65, "Ação Civil Pública Ambiental"),
        (283, "Ação Penal - Crimes Contra o Meio Ambiente"),
        (66, "Ação Popular Ambiental"),
        (7, "Ação Anulatória de Multa Ambiental"),
        (12190, "Desmatamento / Queimada Ilegal"),
        (12191, "Poluição Hídrica / Atmosférica"),
        (12192, "Mineração Ilegal"),
        (12193, "Fauna - Crimes contra Animais Silvestres"),
        (12194, "Licenciamento Ambiental"),
        (12195, "Recuperação de Área Degradada"),
        (12196, "Reserva Legal / APP"),
        (120, "Mandado de Segurança Ambiental"),
        (64, "Improbidade Administrativa Ambiental"),
        (12197, "Demarcação de Terras Indígenas"),
        (12198, "Reforma Agrária / Desapropriação Rural"),
        (12199, "Usucapião Rural / Constitucional"),
        (12200, "Conflito Fundiário / Posse Rural"),
        (91, "Desapropriação para Fins Ambientais"),
    ],
    "eleitoral": [
        (11531, "Prestação de Contas Eleitorais"),
        (11538, "Representação Eleitoral"),
        (11527, "Ação de Impugnação de Mandato Eletivo (AIME)"),
        (11525, "Ação de Investigação Judicial Eleitoral (AIJE)"),
        (11526, "Recurso Contra Expedição de Diploma (RCED)"),
        (11528, "Ação de Impugnação de Registro de Candidatura (AIRC)"),
        (11529, "Consulta Eleitoral"),
        (11530, "Petição Eleitoral"),
        (11532, "Recurso Eleitoral"),
        (11533, "Habeas Corpus Eleitoral"),
        (11534, "Mandado de Segurança Eleitoral"),
        (11535, "Ação Rescisória Eleitoral"),
        (11536, "Conflito de Competência Eleitoral"),
        (11537, "Processo Administrativo Eleitoral"),
        (11539, "Propaganda Eleitoral Irregular"),
        (11540, "Crime Eleitoral"),
        (11541, "Captação Ilícita de Sufrágio"),
        (11542, "Abuso de Poder Econômico/Político"),
    ],
    "infancia": [
        (48, "Adoção c/c Destituição do Poder Familiar"),
        (100, "Medida de Proteção à Criança e Adolescente"),
        (289, "Apuração de Ato Infracional"),
        (131, "Guarda e Tutela da Infância"),
        (12201, "Acolhimento Institucional"),
        (12202, "Acolhimento Familiar"),
        (12203, "Destituição do Poder Familiar"),
        (12204, "Habilitação para Adoção"),
        (12205, "Adoção Nacional"),
        (12206, "Adoção Internacional"),
        (12207, "Medida Socioeducativa - Internação"),
        (12208, "Medida Socioeducativa - Semiliberdade"),
        (12209, "Medida Socioeducativa - Liberdade Assistida"),
        (12210, "Medida Socioeducativa - Prestação de Serviço à Comunidade"),
        (12211, "Advertência (ECA)"),
        (12212, "Remissão (ECA)"),
        (12213, "Autorização de Viagem de Menor"),
        (12214, "Regulamentação de Visitas (Infância)"),
        (12215, "Busca e Apreensão de Menor"),
        (12216, "Alimentos (Infância)"),
        (12217, "Trabalho Infantil - Autorização/Proibição"),
    ],
}
...
def render_fluxo_simplificado_busca() -> None:
    ...
    with st.expander(f"📌 Ações e Classes CNJ de {active_area_info['nome']}", expanded=False):
        ...
        st.markdown("---")
        # Selectbox com TODOS os códigos CNJ da área (lista completa)
        active_area_key = st.session_state["active_legal_area"]
        all_codes_for_area = LEGAL_AREAS_ALL_CODES.get(active_area_key, active_area_info["acoes"])
        st.markdown(f"**Todas as {len(all_codes_for_area)} ações/classes de {active_area_info['nome']}:**")
        selected_action_tuple = st.selectbox(
            f"Selecione uma ação específica de {active_area_info['nome']}:",
            options=all_codes_for_area,
...
def build_process_analysis_insights(
    ...
    classe_codigo = str(first_non_blank(record.get("classe_codigo"), "") or "").strip()
    orgao = str(first_non_blank(record.get("orgao_julgador"), "orgao nao informado") or "").strip()
    assuntos = unique_assuntos_list(record.get("assuntos"))
    ...
    ultima_atualizacao = record.get("ultima_atualizacao")
    ...
    decisao_data = record.get("decisao_data")

    if classe_codigo and classe:
        insights.append(f"O processo esta classificado como `{classe}` (codigo CNJ `{classe_codigo}`).")
    elif classe:
        insights.append(f"O processo esta classificado como `{classe}`.")
    if orgao:
        insights.append(f"O orgao julgador informado no retorno publico e `{orgao}`.")
    if assuntos:
        insights.append(
            f"Os temas publicos mais visiveis neste caso sao: `{', '.join(assuntos[:4])}`."
        )
    if valor_causa:
        insights.append(f"O valor da causa informado no retorno publico foi `{valor_causa}`.")
    if decisao_categoria:
        insights.append(f"O app identificou um desfecho proxy atual como `{decisao_categoria}`.")
    if decisao_movimento:
        movimento_texto = f"`{decisao_movimento}`"
        decisao_data_texto = format_datetime_label(decisao_data)
        if decisao_data_texto:
            insights.append(f"O movimento decisorio mais recente carregado foi {movimento_texto} em `{decisao_data_texto}`.")
        else:
            insights.append(f"O movimento decisorio mais recente carregado foi {movimento_texto}.")
    elif qtd_movimentos:
        insights.append(
            f"O retorno publico trouxe `{format_int_br(qtd_movimentos)}` movimento(s), o que ajuda a reconstruir a linha do tempo do caso."
        )

    if not is_blank_value(data_ajuizamento) and not is_blank_value(ultima_atualizacao):
        try:
            dias_observados = (
                (to_sao_paulo_datetime(ultima_atualizacao) - to_sao_paulo_datetime(data_ajuizamento)).total_seconds()
                / 86400.0
            )
        except Exception:
            dias_observados = None
        if dias_observados is not None and dias_observados >= 0:
            insights.append(
                f"Pelo retorno carregado, ha uma janela observavel de `{format_duration_label(dias_observados)}` entre o ajuizamento e a ultima atualizacao."
            )

    if "dias_ate_decisao_proxy" in getattr(record, "index", []) and not is_blank_value(record.get("dias_ate_decisao_proxy")):
        insights.append(
...
def classe_scope_options_dataframe(df_anpp: pd.DataFrame, max_items: int = 60) -> pd.DataFrame:
    base = top_codigos_dataframe(df_anpp, max_items=max_items).copy()
    if base.empty:
        return pd.DataFrame(columns=["classe_codigo", "classe", "quantidade", "label"])
    base["classe"] = base["classe"].fillna("").astype(str).str.strip()
    base["label"] = base.apply(
        lambda row: (
            f"{row['classe_codigo']} | {row['classe']} ({format_int_br(row['quantidade'])})"
            if str(row.get("classe", "")).strip()
            else f"{row['classe_codigo']} ({format_int_br(row['quantidade'])})"
        ),
        axis=1,
    )
    return base[["classe_codigo", "classe", "quantidade", "label"]]


def filter_dataframe_by_classe_codigo(df_anpp: pd.DataFrame, classe_codigo: Any) -> pd.DataFrame:
    if not isinstance(df_anpp, pd.DataFrame):
        return pd.DataFrame()
    if df_anpp.empty or "classe_codigo" not in df_anpp.columns:
        return df_anpp.copy()
    if classe_codigo in (None, "", "Toda a amostra"):
        return df_anpp.copy()
    try:
        classe_codigo_int = int(str(classe_codigo).strip())
    except Exception:
        return df_anpp.copy()
    base = pd.to_numeric(df_anpp["classe_codigo"], errors="coerce")
...
def filter_hits_by_classe_codigo(hits: Any, classe_codigo: Any) -> list[dict[str, Any]]:
    ...
    for hit in hits:
        if not isinstance(hit, dict):
            continue
        source = hit.get("_source", {})
        codigo = first_non_blank(
            deep_get_path(source, "classe.codigo"),
            deep_get_path(source, "dadosBasicos.classe.codigo"),
        )
        try:
...
def process_movement_frequency_dataframe(movimentos: Any, max_items: int = 10) -> pd.DataFrame:
    if not isinstance(movimentos, list):
        return pd.DataFrame(columns=["movimento", "quantidade"])
    nomes = [
        str(item[1] or "").strip()
...
def process_activity_monthly_series(movimentos: Any, max_meses: int = 12) -> pd.Series:
    if not isinstance(movimentos, list):
        return pd.Series(dtype="int64")
    datas: list[Any] = []
    for item in movimentos:
        if not isinstance(item, (list, tuple)) or len(item) < 3:
            continue
        data_hora = to_sao_paulo_datetime(item[2])
        if pd.notna(data_hora):
            datas.append(data_hora)
    if not datas:
        return pd.Series(dtype="int64")
    return _month_counts_from_series(pd.Series(datas), max_meses=max_meses)


def process_public_roles_dataframe(parties_df: pd.DataFrame) -> pd.DataFrame:
    if not isinstance(parties_df, pd.DataFrame) or parties_df.empty or "papel" not in parties_df.columns:
        return pd.DataFrame(columns=["papel", "quantidade"])
    base = parties_df["papel"].fillna("").astype(str).str.strip()
    base = base[base != ""]
    if base.empty:
        return pd.DataFrame(columns=["papel", "quantidade"])
    return base.value_counts().rename_axis("papel").reset_index(name="quantidade")


def fig_rank_horizontal(
    df_rank: pd.DataFrame,
    label_column: str,
    value_column: str = "quantidade",
    title: str = "Ranking",
    color: str = "#4E79A7",
    max_chars: int = 42,
    empty_message: str = "Sem base suficiente para este ranking.",
) -> Any:
    plt = get_plt()
    if not isinstance(df_rank, pd.DataFrame) or df_rank.empty or label_column not in df_rank.columns or value_column not in df_rank.columns:
    ...
    base = df_rank.copy()
    base[value_column] = pd.to_numeric(base[value_column], errors="coerce")
    base = base[base[value_column].notna()]
    if base.empty:
        fig, ax = plt.subplots(figsize=(8.8, 3.8))
        ax.set_title(title)
        ax.text(0.5, 0.5, empty_message, ha="center", va="center")
    ...
    labels = base[label_column].fillna("").astype(str).map(
        lambda valor: shorten_display_label(valor, max_chars=max_chars)
    )
    valores = base[value_column].astype(float)
    altura = max(3.6, min(7.2, 1.6 + 0.48 * len(base)))
    fig, ax = plt.subplots(figsize=(9.2, altura))
    ax.barh(labels, valores, color=color, alpha=0.92)
    ax.invert_yaxis()
    ax.set_title(title)
    ax.set_xlabel("Quantidade")
    ax.grid(axis="x", linestyle="--", alpha=0.3)
    max_valor = float(valores.max()) if len(valores) else 0.0
    deslocamento = max(max_valor * 0.01, 0.5)
    for i, valor in enumerate(valores):
        ax.text(float(valor) + deslocamento, i, format_int_br(int(valor)), va="center", fontsize=9)
    fig.tight_layout()
    return fig


def fig_process_timeline_summary(record: Any) -> Any:
    plt = get_plt()
    data_ajuizamento = to_sao_paulo_datetime(record.get("data_ajuizamento")) if record is not None else pd.NaT
    decisao_data = to_sao_paulo_datetime(record.get("decisao_data")) if record is not None else pd.NaT
    ultima_atualizacao = to_sao_paulo_datetime(record.get("ultima_atualizacao")) if record is not None else pd.NaT

    eventos: list[tuple[str, Any, str]] = []
    if pd.notna(data_ajuizamento):
        eventos.append(("Ajuizamento", data_ajuizamento, "#4E79A7"))
    if pd.notna(decisao_data):
        eventos.append(("1o desfecho proxy", decisao_data, "#E15759"))
    if pd.notna(ultima_atualizacao):
        eventos.append(("Ultima atualizacao", ultima_atualizacao, "#59A14F"))

    fig, ax = plt.subplots(figsize=(9.4, 3.0))
    if not eventos:
        ax.set_title("Linha do tempo resumida do processo")
        ax.text(0.5, 0.5, "Sem datas suficientes para montar a linha do tempo.", ha="center", va="center")
        ax.axis("off")
        return fig

    data_base = eventos[0][1]
    if pd.isna(data_base):
        data_base = min(evento[1] for evento in eventos if pd.notna(evento[1]))
    posicoes = []
    for _, data_evento, _ in eventos:
        diferenca = (data_evento - data_base).total_seconds() / 86400.0 if pd.notna(data_evento) and pd.notna(data_base) else 0.0
        posicoes.append(max(float(diferenca), 0.0))

    eixo_inicio = min(posicoes) if posicoes else 0.0
    eixo_fim = max(posicoes) if posicoes else 0.0
    if eixo_inicio == eixo_fim:
        eixo_fim = eixo_inicio + 1.0
    ax.hlines(0, eixo_inicio, eixo_fim, color="#B9C3D0", linewidth=2.2, alpha=0.8)
    for posicao, (label, data_evento, cor) in zip(posicoes, eventos):
        ax.scatter(posicao, 0, s=130, color=cor, zorder=3)
        ax.text(
            posicao,
            0.08 if posicao % 2 == 0 else -0.14,
            f"{label}\n{format_datetime_label(data_evento, include_time=False)}",
            ha="center",
            va="center",
            fontsize=9,
        )
    ax.set_title("Linha do tempo resumida do processo")
    ax.set_xlabel("Dias desde o ajuizamento")
    ax.set_yticks([])
...
def fig_process_activity_monthly(movimentos: Any) -> Any:
    plt = get_plt()
    serie = process_activity_monthly_series(movimentos)
    if serie.empty:
        fig, ax = plt.subplots(figsize=(9.2, 3.8))
        ax.set_title("Atividade mensal do processo")
        ax.text(0.5, 0.5, "Sem datas suficientes nos movimentos para montar o historico.", ha="center", va="center")
        ax.axis("off")
        return fig
    ...
    fig, ax = plt.subplots(figsize=(9.2, 3.8))
    ax.bar(posicoes, serie.values, color="#59A14F", alpha=0.9, width=0.65)
    ax.set_title("Atividade mensal do processo")
    ax.set_xlabel("Meses")
    ...
    for i, valor in enumerate(serie.values):
        ax.text(i, float(valor) + 0.2, format_int_br(int(valor)), ha="center", va="bottom", fontsize=9)
    fig.tight_layout()
    return fig
...
def render() -> None:
    ...
    process_context_number = ""
    process_context_record = None
    if usar_numero_processo and not df_anpp.empty:
        process_context_number = normalize_numero_processo(last_query_context.get("numero_processo"))
        if not process_context_number:
            process_context_number = normalize_numero_processo(df_anpp.iloc[0].get("numero_processo"))
        if process_context_number:
            process_context_record = find_process_record(process_context_number, df_anpp, df_decisao)

    if usar_numero_processo and process_context_record is not None and len(process_context_record) > 0:
        st.subheader("Painel do processo")
        classe_codigo_texto = str(process_context_record.get("classe_codigo", "") or "").strip() or "-"
        qtd_movimentos_contexto = count_movimentos(process_context_record.get("movimentos"))
        valor_causa_contexto = format_currency_br(process_context_record.get("valor_causa")) or "Sem base"
        tempo_observado = "-"
        try:
            data_ajuizamento_contexto = to_sao_paulo_datetime(process_context_record.get("data_ajuizamento"))
            ultima_atualizacao_contexto = to_sao_paulo_datetime(process_context_record.get("ultima_atualizacao"))
            if pd.notna(data_ajuizamento_contexto) and pd.notna(ultima_atualizacao_contexto):
                tempo_observado = format_duration_label(
                    (ultima_atualizacao_contexto - data_ajuizamento_contexto).total_seconds() / 86400.0
                )
        except Exception:
            tempo_observado = "-"
        c1, c2, c3, c4 = st.columns(4)
        c1.metric("Classe CNJ", classe_codigo_texto)
        c2.metric("Movimentos", format_int_br(qtd_movimentos_contexto))
        c3.metric("Valor da causa", valor_causa_contexto)
        c4.metric("Tempo observado", tempo_observado)
        st.caption(
            f"Classe: `{str(process_context_record.get('classe', '') or '').strip() or 'Nao informada'}` | "
    ...
    if usar_numero_processo:
        st.caption(
            "Nesta consulta por numero do processo, a plataforma prioriza o caso individual e deixa a jurimetria geral em segundo plano."
        )
        area_options = ["Processos", "Analise do processo", "Downloads"]
    ...
    mostrar_bloco_processos = bool(
        ...
        or (usar_numero_processo and area_resultados == "Analise do processo")
    )

    selected_process_number = ""
    selected_process_record = None
    selected_raw_source: dict[str, Any] = {}
    ...
    if not process_summary_df.empty and mostrar_bloco_processos:
        ...
        if selected_process_number:
            selected_process_record = find_process_record(selected_process_number, df_anpp, df_decisao)
            selected_raw_source = find_raw_source_for_process(selected_process_number, raw_hits)
            selected_process_metadata_df = build_process_metadata_dataframe(
            ...
            if isinstance(selected_raw_source, dict) and selected_raw_source:
                with st.expander("Ver JSON publico retornado pelo DataJud", expanded=False):
                    st.json(selected_raw_source, expanded=False)
    ...
    if area_suporta_refino_jurimetria and not classe_scope_df.empty:
        ...
        classe_scope_code_to_meta = {
            str(row["classe_codigo"]): {
                "classe": str(row.get("classe", "") or "").strip(),
    ...
    if area_resultados == "Temas e estrategia" and usar_numero_processo:
    ...
    elif area_resultados == "Temas e estrategia" and (not isinstance(df_area_decisao, pd.DataFrame) or df_area_decisao.empty):
        st.info(
                ...
                with st.spinner("Carregando leitura decisoria complementar..."):
                    try:
                        ...
                        if df_decisao_carregado.empty:
                            ...
                            st.rerun()
    elif area_resultados == "Temas e estrategia" and isinstance(df_area_decisao, pd.DataFrame) and not df_area_decisao.empty:
        temas_decisao = assuntos_distintos_dataframe(df_area_decisao)
        temas_overview = theme_overview_dataframe(df_area_decisao)
        qtd_decisao_area = int(len(df_area_decisao))
        ...
        if qtd_decisao_area:
            st.caption(
                f"Analise baseada em ate {qtd_decisao_area:,} registros recentes com movimentos completos.".replace(",", ".")
            )
        if classe_scope_codigo:
            st.caption(
                f"Os indicadores abaixo estao filtrados para o codigo CNJ `{classe_scope_codigo}`"
                + (f" ({classe_scope_nome})" if classe_scope_nome else "")
                + "."
            )
        ...
        if tema_opcoes:
            ...
            tema_query_signature = (
                f"{tema_consulta_aplicado}|{qtd_decisao_area}|{len(tema_opcoes)}|"
                f"{int(bool(busca_tema_direto))}|{classe_scope_codigo or 'toda'}"
            )
        ...
        if tema_escolhido == "Todos os temas":
            ...
            d3.metric("Base com movimentos", f"{qtd_decisao_area:,}".replace(",", "."))
            st.caption(
            ...
            df_tema_decisao = filter_dataframe_by_tema(df_area_decisao, tema_escolhido)
    ...
    if area_resultados == "Processos":
        ...
        if selected_process_record is not None and len(selected_process_record) > 0:
            st.subheader("Painel visual do processo selecionado")
            st.caption(
                "Esses graficos ajudam a ler o caso em si: cronologia, atividade, movimentos mais recorrentes e temas/envolvidos publicos."
            )
            movement_rank_df = process_movement_frequency_dataframe(selected_process_record.get("movimentos"))
            public_roles_df = process_public_roles_dataframe(selected_public_parties_df)
            temas_processo_chart = unique_assuntos_list(selected_process_record.get("assuntos"))
            temas_processo_df = pd.DataFrame(
                {"tema": temas_processo_chart, "quantidade": [1] * len(temas_processo_chart)}
            ) if temas_processo_chart else pd.DataFrame(columns=["tema", "quantidade"])

            pv1, pv2 = st.columns(2)
            with pv1:
                st.pyplot(fig_process_timeline_summary(selected_process_record), clear_figure=True)
            with pv2:
                st.pyplot(fig_process_activity_monthly(selected_process_record.get("movimentos")), clear_figure=True)
            ...
            with pv3:
                st.pyplot(
                    fig_rank_horizontal(
                        movement_rank_df,
                        "movimento",
                        title="Movimentos mais recorrentes do processo",
                        color="#E15759",
                        max_chars=46,
                        empty_message="Sem movimentos suficientes para ranquear.",
                    ),
                    clear_figure=True,
                )
            with pv4:
                if not public_roles_df.empty:
                    st.pyplot(
                        fig_rank_horizontal(
                            public_roles_df,
                            "papel",
                            title="Envolvidos publicos por papel",
                            color="#76B7B2",
                            max_chars=40,
                            empty_message="Sem envolvidos publicos suficientes para ranquear.",
                        ),
                        clear_figure=True,
                    )
                else:
                    st.pyplot(
                        fig_rank_horizontal(
                            temas_processo_df,
                            "tema",
                            title="Temas publicos do processo",
                            color="#59A14F",
                            max_chars=46,
                            empty_message="Sem temas publicos identificados neste retorno.",
                        ),
                        clear_figure=True,
                    )
        elif usar_numero_processo:
            st.caption(
                "Como esta consulta foi feita por numero do processo, o foco desta area fica na ficha do caso e nao em rankings gerais da amostra."
            )

    if area_resultados == "Analise do processo" and usar_numero_processo:
        st.subheader("Analise direta do processo")
        st.caption(
            "Aqui a leitura fica 100% centrada no caso pesquisado, sem misturar indicadores gerais da amostra."
        )
        if selected_process_record is None or len(selected_process_record) == 0:
            st.info("Nao encontrei detalhes suficientes para aprofundar este processo nesta consulta.")
        else:
            temas_processo = unique_assuntos_list(selected_process_record.get("assuntos"))
            qtd_movimentos_processo = count_movimentos(selected_process_record.get("movimentos"))
            dias_ate_decisao_proxy = selected_process_record.get("dias_ate_decisao_proxy")
            tempo_observado_processo = "-"
            try:
                data_ajuizamento_processo = to_sao_paulo_datetime(selected_process_record.get("data_ajuizamento"))
                ultima_atualizacao_processo = to_sao_paulo_datetime(selected_process_record.get("ultima_atualizacao"))
                if pd.notna(data_ajuizamento_processo) and pd.notna(ultima_atualizacao_processo):
                    tempo_observado_processo = format_duration_label(
                        (ultima_atualizacao_processo - data_ajuizamento_processo).total_seconds() / 86400.0
                    )
            except Exception:
                tempo_observado_processo = "-"

            a1, a2, a3, a4 = st.columns(4)
            a1.metric("Temas publicos", format_int_br(len(temas_processo)))
            a2.metric("Movimentos carregados", format_int_br(qtd_movimentos_processo))
            a3.metric(
                "Primeiro desfecho proxy",
                format_duration_label(dias_ate_decisao_proxy) if not is_blank_value(dias_ate_decisao_proxy) else "Sem base",
            )
            ...
            with col_leitura:
                ...
                if selected_process_summary_text:
                    st.info(selected_process_summary_text)
                for insight in process_insights:
                    st.markdown(f"- {insight}")
            with col_estrutura:
                st.markdown("**Estrutura do caso**")
                estrutura_rows = [
                    ("Numero do processo", selected_process_number),
                    ("Classe", str(selected_process_record.get("classe", "") or "").strip()),
                    ("Codigo da classe", str(selected_process_record.get("classe_codigo", "") or "").strip()),
                    ("Orgao julgador", str(selected_process_record.get("orgao_julgador", "") or "").strip()),
                    ("Data de ajuizamento", format_datetime_label(selected_process_record.get("data_ajuizamento"), include_time=False)),
                    ("Ultima atualizacao", format_datetime_label(selected_process_record.get("ultima_atualizacao"))),
            ...
            process_roles_df = process_public_roles_dataframe(selected_public_parties_df)
            temas_processo_df = pd.DataFrame(
                {"tema": temas_processo, "quantidade": [1] * len(temas_processo)}
            ) if temas_processo else pd.DataFrame(columns=["tema", "quantidade"])
            g1, g2 = st.columns(2)
            with g1:
                st.pyplot(fig_process_timeline_summary(selected_process_record), clear_figure=True)
            with g2:
            ...
            with detalhe_tabs[3]:
                ...
                with col_temas_processo:
                    ...
                    if temas_processo:
                        st.dataframe(pd.DataFrame({"tema": temas_processo}), use_container_width=True, height=260)
                    else:
            ...
            with detalhe_tabs[4]:
                if not selected_public_fields_df.empty:
                    ...
                    st.info("Nao encontrei campos publicos adicionais alem da ficha basica.")
    ...
    if area_resultados == "Estatisticas":
        ...
        if classe_scope_codigo:
            st.caption(
                f"Estatisticas filtradas para o codigo CNJ `{classe_scope_codigo}`"
                + (f" ({classe_scope_nome})" if classe_scope_nome else "")
                + "."
            )
        ...
        with col_a:
            ...
            st.pyplot(fig_horario(df_stats_base), clear_figure=True)
        with col_b:
            ...
            if isinstance(top_classes_df_stats, pd.DataFrame) and not top_classes_df_stats.empty:
        ...
        if int(valor_causa_info_stats["com_valor"] or 0) > 0:
            ...
            st.pyplot(fig_boxplot_valor_causa(df_stats_base), clear_figure=True)
            valor_classe_df = valor_causa_por_classe_dataframe(df_stats_base)
        ...
        if not ranking_envolvidos_df.empty:
            ...
            st.caption(
                "Este ranking respeita o recorte atual da estatistica. Se voce escolher um codigo CNJ acima, ele fica vinculado a essa classe processual."
            )
            ranking_passivo_df = build_party_ranking_dataframe(raw_hits_stats, role_filter="passivo")
            ranking_ativo_df = build_party_ranking_dataframe(raw_hits_stats, role_filter="ativo")
        ...
        if mostrar_graficos_avancados:
            ...
            st.pyplot(fig_fluxo_mensal(df_stats_mensal), clear_figure=True)
            ...
            st.pyplot(fig_heatmap_dia_hora(df_stats_base), clear_figure=True)
        else:
        ...
        if not top_codigos_plot.empty:
            top_codigos_plot["label"] = top_codigos_plot.apply(
                lambda row: (
                    f"{row['classe_codigo']} | {row['classe']}"
                    if str(row.get("classe", "")).strip()
                    else str(row.get("classe_codigo", "")).strip()
                ),
                axis=1,
            )
        ...
        with col_codigos:
            ...
            st.pyplot(
                fig_rank_horizontal(
                    top_codigos_plot,
                    "label",
                    title="Top codigos da sigla",
                    color="#4E79A7",
                    max_chars=42,
                    empty_message="Sem base suficiente para ranquear codigos.",
                ),
                clear_figure=True,
            )
        with col_orgaos:
        ...
        with col_assuntos:
            ...
            st.pyplot(
                fig_rank_horizontal(
                    top_assuntos,
                    "assunto",
                    title="Top assuntos da sigla",
                    color="#59A14F",
                    max_chars=42,
                    empty_message="Sem base suficiente para ranquear assuntos.",
                ),
                clear_figure=True,
            )
